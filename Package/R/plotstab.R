...
#' @param output_N The prefix used for the output (a character)
#' @param outputDir Set output directory (a character)
#'
#' @examples
#'
...
#' plotstab(data = perm, info = stability, outputName = "Example", outputDir = "./")
#'
#' @export

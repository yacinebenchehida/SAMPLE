...
cat(paste("Input file name: ",args[1],sep=""),"\n")
...
count = 1 # Counter that will by incremented for each taxa. This counter is used to choice the colours and figure out the spatial coordinate of the geom_text for the stability threshold.
